...
- `narrator.SLM`: expands room `description_seed` into 2-4 atmospheric sentences via local SLM; non-room events and empty descriptions delegate to fallback `Narrator`
